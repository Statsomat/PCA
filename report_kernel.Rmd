...
```{r, results="asis", eval=eval2}
cat("\n### Standardized Loadings Plots (Coordinates)", fill=TRUE)
cat("Coordinates given by the correlations. Cos2 is variance explained. ", fill=TRUE)
cat("\\newline", fill=TRUE)
...
corrplot(pca$var$cor, is.corr=FALSE)
```
