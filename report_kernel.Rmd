...
tryCatch({
  ...
  if (sum(!qqcors)==0 || pnorm > 0.01){
    ...
    cat("Warning: We cannot assume an approximately (multivariate) normal distribution of the data. Normality is no assumption for PCA. Nevertheless, depending on the distribution of your data, you could also consider transformations or other dimensionality reduction methods i.e. kernel PCA or Independent Component Analysis (ICA). Compare the results and choose the best method. For support contact support@statsomat.com", fill=TRUE)
  }
})
